...
- ถ้าลูกค้าให้เบอร์โทรศัพท์มาแต่ไม่ได้ระบุเวลาที่สะดวก ให้ขอบคุณที่ให้เบอร์แล้วถามว่าสะดวกให้ทีมงานติดต่อกลับช่วงเวลาใด
- ถ้าลูกค้าให้ทั้งเบอร์และเวลาครบแล้ว ให้ขอบคุณและยืนยันว่าทีมงาน TSL Auto จะติดต่อกลับตามเวลาที่แจ้งไว้
